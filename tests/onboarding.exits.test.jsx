...
import { postAuthDestination } from 'src/platform/pages/auth/postAuthDestination.js';
import InstallExtensionPage from 'src/platform/pages/auth/InstallExtensionPage.jsx';
