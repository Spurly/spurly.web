 ...
 *
 * Lives in platform rather than inside products/hub itself: this thin
 * wrapper around `POST /hub/searches/import` mirrors how the backend keeps
 * Hub's own module isolated from `platform/people` and instead shares only
 * through `platform/*`.
 *
