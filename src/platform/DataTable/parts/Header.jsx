...
export function Header({
  ...
  return (
    <thead className={sticky ? `sticky top-0 z-[3] bg-[var(--ui-surface-card)] transition-shadow duration-[var(--ui-dur-base)] ${scrolled ? 'shadow-[0_1px_3px_rgba(24,24,27,0.07)]' : ''}` : undefined}>
      <tr
        onDragLeave={
          reorderable
            ? (event) => {
