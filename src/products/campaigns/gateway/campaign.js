 ...
 */
async function createCampaign({ name, type, note, messageTemplate, leadIds, searchId } = {}) {
...
async function addLeads(id, { leadIds, searchId } = {}) {
...
async function updateCampaign(id, { name, note, messageTemplate } = {}) {
  const body = {};
