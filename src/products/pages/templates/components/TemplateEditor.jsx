...
const FIELD_CLASS =
  ...
  'text-[length:var(--ui-t-body)] text-[var(--ui-text-primary)] placeholder:text-[var(--ui-text-tertiary)] ' +
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-1.5">
        <label className="text-[length:var(--ui-t-body)] font-medium text-[var(--ui-text-primary)]">
          Template name
        </label>
        <input
          value={form.name}
      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 text-[length:var(--ui-t-label)] font-medium text-[var(--ui-text-secondary)] hover:text-[var(--ui-text-primary)] transition-colors"
            >
        ...
        <div className="flex flex-wrap items-center gap-1.5">
          <span className="text-[length:var(--ui-t-label)] text-[var(--ui-text-tertiary)] mr-0.5">Insert</span>
          {TEMPLATE_TOKENS.map((t) => (
            <button
              ...
              className="px-2 h-6 rounded-[var(--ui-radius-sm)] font-mono text-[length:var(--ui-t-meta)] text-[var(--ui-accent-fg)] bg-[var(--ui-accent-tint)] hover:bg-[var(--ui-accent-tint-strong)] transition-colors disabled:opacity-50"
            >
              {t.token}
            </button>
          ))}
        ...
        <div className="flex items-start justify-between gap-3 text-[length:var(--ui-t-label)]">
          <span
        ...
        {unknownTokens.length > 0 && (
          <div
            className="flex items-start gap-2 px-3 py-2.5 rounded-[var(--ui-radius-lg)] text-[length:var(--ui-t-label)]"
        ...
        {showPreview && (
          <div
            className="px-4 py-3 rounded-[var(--ui-radius-lg)] text-[length:var(--ui-t-body)] leading-relaxed whitespace-pre-wrap"
            style={{
              background: 'var(--ui-surface-sunken)',
              border: '1px dashed var(--ui-border)',
              color: preview ? 'var(--ui-text-primary)' : 'var(--ui-text-tertiary)',
            }}
          >
            {preview || 'Nothing to preview yet.'}
            <div className="mt-2 text-[length:var(--ui-t-meta)] text-[var(--ui-text-tertiary)]">
      ...
      {error && (
        <p
          className="text-[length:var(--ui-t-body)] font-medium px-3 py-2.5 rounded-[var(--ui-radius-lg)]"
      ...
      <div className="flex items-center justify-end gap-2 pt-1">
        <button
          ...
          onClick={onCancel}
          disabled={saving}
          className="h-8 px-3 rounded-[var(--ui-radius-sm)] text-[length:var(--ui-t-body)] font-medium text-[var(--ui-text-secondary)] hover:bg-[var(--ui-surface-hover)] hover:text-[var(--ui-text-primary)] transition-colors disabled:opacity-50"
        >
          Cancel
        </button>
        <button
