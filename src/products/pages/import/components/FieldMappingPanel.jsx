...
export function FieldMappingPanel({
  ...
  return (
    <>
      ...
      >
        {ok ? (
          <CheckCircle2 size={18} className="shrink-0 mt-0.5" style={{ color: 'var(--ui-success)' }} />
        ) : (
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[length:var(--ui-t-body)] mt-0.5" style={{ color: 'var(--ui-text-secondary)' }}>
            {ok
      ...
      >
        <div
          className="hidden sm:grid grid-cols-[minmax(0,1fr)_minmax(0,1.1fr)_minmax(0,1.2fr)] gap-4 px-[var(--ui-pad-lg)] py-2.5 text-[length:var(--ui-t-label)] font-medium uppercase tracking-[0.04em]"
        ...
        {IMPORT_FIELDS.map((field) => {
          ...
          return (
            ...
            >
              <div className="min-w-0">
                <p className="text-[length:var(--ui-t-body)] text-[var(--ui-text-primary)] flex items-center gap-1.5">
                  {field.label}
                  {(field.required || field.requiredGroup) && (
                    <span
                      className="text-[length:var(--ui-t-meta)]"
                ...
                {field.hint && (
                  <p className="text-[length:var(--ui-t-label)] mt-0.5" style={{ color: 'var(--ui-text-tertiary)' }}>
                    {field.hint}
                  </p>
                )}
              </div>
              ...
              <p
                className="text-[length:var(--ui-t-body)] truncate"
        ...
        <p className="px-[var(--ui-pad-lg)] py-3 text-[length:var(--ui-t-label)]" style={{ color: 'var(--ui-text-tertiary)' }}>
