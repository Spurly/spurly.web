    ...
    <AdminLayout title="Pricing" subtitle="Plans & credit cost per action">
      ...
      <div className="mb-12">
        <div className="flex items-start justify-between gap-4 mb-5">
          <div className="max-w-2xl">
            <h3 className="text-[length:var(--ui-t-section)] font-medium text-[var(--ui-text-primary)]">
              Subscription plans
            </h3>
            <p className="text-[var(--ui-text-secondary)] text-[length:var(--ui-t-body)] leading-relaxed mt-1">
      ...
      {loading ? (
        ...
        <div className="max-w-3xl">
          <h3 className="text-[length:var(--ui-t-section)] font-medium text-[var(--ui-text-primary)] mb-3">
          ...
          <div className="mb-6">
            ...
            <p className="text-[var(--ui-text-tertiary)] text-[length:var(--ui-t-label)] mt-2">
          ...
          <div className="bg-[var(--ui-surface-card)] border border-[var(--ui-border)] rounded-[var(--ui-radius-lg)] shadow-[var(--ui-shadow-sm)] overflow-hidden">
            <table className="w-full">
              <thead>
                <tr className="bg-[var(--ui-surface-page)] text-left text-[length:var(--ui-t-label)] text-[var(--ui-text-tertiary)]">
                ...
                {costs.map((c) => (
                  <tr key={c.feature} className="hover:bg-[var(--ui-surface-page)]">
                    ...
                    <td className="px-[var(--ui-pad-lg)] py-4">
                      <code className="text-[length:var(--ui-t-meta)] bg-[var(--ui-surface-sunken)] px-2 py-1 rounded text-[var(--ui-text-secondary)]">
                        {c.feature}
                      </code>
                    </td>
                    <td className="px-[var(--ui-pad-lg)] py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <span
                          className={`text-[length:var(--ui-t-label)] font-medium ${
                    ...
                    <td className="px-[var(--ui-pad-lg)] py-4">
                      <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-[var(--ui-radius-md)] text-[length:var(--ui-t-label)] font-medium transition-colors ${
