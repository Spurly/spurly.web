...
export const paymentColumns = [
  ...
  },
  {
    ...
    render: (_v, row) => (
      <span className="flex flex-col items-end tabular-nums">
        ...
        {row.discount > 0 && (
          <span className="text-[length:var(--ui-t-meta)] text-[var(--ui-text-secondary)] line-through">
  ...
  },
  {
    ...
    render: (value) =>
      value ? (
        <code className="rounded-[var(--ui-radius-xs)] bg-[var(--ui-surface-sunken)] px-1.5 py-0.5 font-mono text-[length:var(--ui-t-meta)] text-[var(--ui-text-secondary)]">
          {value}
        </code>
      ) : (
